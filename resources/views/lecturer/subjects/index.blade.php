               ...
               <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
                  <thead class="bg-gray-100">
                        <tr>
                           ...
                           <th class="px-4 py-2 text-left text-sm font-medium text-gray-700">{{ __('Class Group') }}</th>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($subjects as $subject)
                            <tr>
                                <td class="px-6 py-4 text-sm text-gray-800">{{ $subject->name }}</td>
                                <td class="px-6 py-4 text-sm text-gray-800">{{ $subject->classGroup->name }}</td>
